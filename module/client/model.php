...
class clientModel extends model
{
    ...
    public function getUpgrade($version)
    {
        ...
        foreach($latestUpgrades as $upgrade)
        {
            ...
            $downloads->linux32 = $downloads->linux32zip;
            $downloads->linux64 = $downloads->linux64zip;
            $downloads->mac64   = $downloads->macOSzip;
            $downloads->win32   = $downloads->win32zip;
            $downloads->win64   = $downloads->win64zip;
